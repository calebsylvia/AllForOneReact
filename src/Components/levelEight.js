import { levelEightCall } from "../Services/Data-Service";
...
export default function LevelEight() {
  ...
  const getResult = async () => {
    const response = await levelEightCall(input);
    setResult(response);
  }
  return (
    ...
    <div className="pl-3">
      <div className="font-text text-neutral-100 max-[769px]:text-center">
        <p className="text-8xl max-[321px]:text-6xl">LEVEL 8</p>
        <p className="text-lg sm:text-3xl">MAGIC 8 BALL!</p>
      </div>
      ...
      <div className="flex font-text text-[#D9CAB3] mt-6 lg:mt-16 mb-2  max-[769px]:justify-center">
        <Button
