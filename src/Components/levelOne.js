...
import { levelOneCall } from "../Services/Data-Service";
...
export default function LevelOne() {
  ...
  const getResult = async () => {
    const response = await levelOneCall(inputOne, inputTwo);
    setResult(response);
  };
      ...
      <div className="columns-1 lg:columns-2 lg:space-x-10 pt-5 pl-0 sm:pl-5 max-[769px]:mx-auto">
        <div className="pl-3">
          <div className="font-text text-neutral-100 max-[769px]:text-center">
            <p className="text-8xl max-[321px]:text-6xl">LEVEL 1</p>
            <p className="text-lg sm:text-3xl">TWO SUM!</p>
          </div>
