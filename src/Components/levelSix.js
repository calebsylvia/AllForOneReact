import { levelSixCall } from "../Services/Data-Service";
...
export default function LevelSix() {
  ...
  const getResult = async () => {
    const response = await levelSixCall(input);
    setResult(response);
  }
  return (
    <div className="columns-1 lg:columns-2 lg:space-x-10 pt-5 pl-0 sm:pl-5 max-[769px]:mx-auto">
      <div className="pl-3">
        <div className="font-text text-neutral-100 max-[769px]:text-center">
          <p className="text-8xl max-[321px]:text-6xl">LEVEL 6</p>
          <p className="text-lg sm:text-3xl">REVERSE IT 1!</p>
        </div>
