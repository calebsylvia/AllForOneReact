import { levelThreeCall } from "../Services/Data-Service";
...
export default function LevelThree() {
    ...
    const getResult = async () => {
      const response = await levelThreeCall(inputOne, inputTwo);
      setResult(response);
    }
  return (
    <>
    <div className="columns-1 lg:columns-2 lg:space-x-10 pt-5 pl-0 sm:pl-5 max-[769px]:mx-auto">
      <div className="pl-3">
        <div className="font-text text-neutral-100 max-[769px]:text-center">
          <p className="text-8xl max-[376px]:text-6xl">LEVEL 3</p>
          <p className="text-lg sm:text-3xl">COMPARE!</p>
        </div>
