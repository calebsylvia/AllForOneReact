import { levelZeroCall } from "../Services/Data-Service";
...
export default function LevelZero() {
    ...
    const response = await levelZeroCall(input);
    setResult(response);
}
  return (
    <div className="columns-1 lg:columns-2 lg:space-x-10 pt-5 pl-0 sm:pl-5 max-[769px]:mx-auto">
      <div className="pl-3">
        <div className="font-text text-neutral-100 max-[769px]:text-center">
          <p className="text-8xl max-[321px]:text-6xl">LEVEL 0</p>
          <p className="text-lg sm:text-3xl">SAY HELLO!</p>
        </div>
        ...
        <div className="font-text mt-12 lg:mt-52 w-72 md:w-96 mx-auto lg:mx-0">
          <p className="text-neutral-100 text-3xl max-[769px]:hidden">
            ENTER A NAME:{" "}
          </p>
          <input
            id="input"
